...
- Framework baseline: 1.2.0; Project Context Maintenance Procedure: 1.1.0; Project Context Blueprint: 1.0.0; Software Standards: Foundation 0.2.0; other pre-production standards remain 0.1.0.
